    ...
    if plot_type == "violin":
        ...
        if features is not None:
            ...
            for pos, i in enumerate(feature_order):
                shaps = shap_values[select_index, i]  #ADD SILVIA THE INDEX
                ...
                values = features[select_index, i]#ADD SILVIA THE INDEX
            ...
            parts = pl.violinplot(
                shap_values[select_index, feature_order], #ADD SILVIA
