...
# input: hormones_arch (DataFrame), metadata_cols (list), if_dominant_archetype (bool), mapping (ndarray)
# output: loocv_results (dict), aligned_true (list) — model predictions + aligned labels
def predict_and_align(hormones_arch, metadata_cols, if_dominant_archetype, mapping):
