...
sheet_name <- 'proba_male_P_status'
sheet_name_ac <- 'accuracy_male_P_status'
title <- 'male_P_status.pdf'
title
...
data$probability <- 1
data[data$true_status == "O",]$probability <- data[data$true_status == "O",]$O
data[data$true_status == "P",]$probability <- data[data$true_status == "P",]$P
