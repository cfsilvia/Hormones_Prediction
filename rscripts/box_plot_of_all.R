...
p <- ggplot(data_long, aes(x = Hormone, y = Value, fill = ColorGroup)) + 
  ...
  scale_y_continuous(
    breaks = c(
      ...
      seq(10000, 20000, by = 2000),
      seq(28000, 140000, by = 20000)
    ),
  ...
  #scale_y_break(c(3, 15),    scales = 4, ticklabels = NULL, expand = TRUE, space = 0.2) +
  scale_y_break(c(3, 4),    scales = 4, ticklabels = NULL, expand = TRUE, space = 0.5) +
  scale_y_break(c(10, 15),    scales = 4, ticklabels = NULL, expand = TRUE, space = 0.5) +
  scale_y_break(c(65, 170),  scales = 4, ticklabels = NULL, expand = TRUE, space = 0.5) +
  scale_y_break(c(400, 500),  scales = 4, ticklabels = NULL, expand = TRUE, space = 0.5) +
  scale_y_break(c(1500, 2000),  scales = 4, ticklabels = NULL, expand = TRUE, space = 0.5) +
  scale_y_break(c(9000, 10000),  scales = 4, ticklabels = NULL, expand = TRUE, space = 0.5) +
  scale_y_break(c(20000, 28000), scales = 4, ticklabels = NULL, expand = TRUE, space = 0.5) +
...
ggsave(paste(output,"allbiomarkers.pdf", sep=""), device="pdf")
